...
- [Agent Skills Overview - Agent Skills](#agent-skills-overview-agent-skills)
- [Client Showcase - Agent Skills](#client-showcase-agent-skills)
- [How to add skills support to your agent - Agent Skills](#how-to-add-skills-support-to-your-agent-agent-skills)
- [Best practices for skill creators - Agent Skills](#best-practices-for-skill-creators-agent-skills)
- [Optimizing skill descriptions - Agent Skills](#optimizing-skill-descriptions-agent-skills)
- [Evaluating skill output quality - Agent Skills](#evaluating-skill-output-quality-agent-skills)
- [Quickstart - Agent Skills](#quickstart-agent-skills)
- [Specification - Agent Skills](#specification-agent-skills)
- [Using scripts in skills - Agent Skills](#using-scripts-in-skills-agent-skills)
...
[​](https://agentskills.io/home#how-do-agent-skills-work)
...
[​](https://agentskills.io/home#where-can-i-use-agent-skills)
...
, released as an open standard, and has been adopted by a growing number of agent products. The standard is open to contributions from the broader ecosystem. Come join the discussion on [GitHub](https://github.com/agentskills/agentskills)
 or [Discord](https://discord.gg/MKPE9g8aUy)
!

[​](https://agentskills.io/home#get-started-with-agent-skills)
...
[Skip to main content](https://agentskills.io/clients#content-area)
...
[Databricks Genie Code](https://databricks.com/)
...
[Setup instructions](https://mux.coder.com/agent-skills)
 [Source code](https://github.com/coder/mux)
...
[Superconductor](https://superconductor.com/)
...
[Setup instructions](https://docs.roocode.com/features/skills)
...
[Setup instructions](https://docs.github.com/en/copilot/concepts/agents/about-agent-skills)
 [Source code](https://github.com/microsoft/vscode-copilot-chat)
...
[Setup instructions](https://laravel.com/docs/12.x/boost#agent-skills)
 [Source code](https://github.com/laravel/boost)
...
[Setup instructions](https://www.trae.ai/blog/trae_tutorial_0115)
 [Source code](https://github.com/bytedance/trae-agent)
...
[Setup instructions](https://github.com/google-ai-edge/gallery/tree/main/skills)
 [Source code](https://github.com/google-ai-edge/gallery)
...
[Setup instructions](https://autohand.ai/docs/working-with-autohand-code/agent-skills.html)
 [Source code](https://github.com/autohandai/code-cli)
...
[Setup instructions](https://block.github.io/goose/docs/guides/context-engineering/using-skills/)
...
[Setup instructions](https://opencode.ai/docs/skills/)
...
[Setup instructions](https://docs.openhands.dev/overview/skills)
 [Source code](https://github.com/OpenHands/OpenHands)
...
[Setup instructions](https://github.com/vinhnx/vtcode/blob/main/docs/skills/SKILLS_GUIDE.md)
...
[![Pulumi Neo](https://agentskills.io/images/logos/pulumi-neo/pulumi-neo-logo-light.svg)![Pulumi Neo](https://agentskills.io/images/logos/pulumi-neo/pulumi-neo-logo-dark.svg)](https://www.pulumi.com/product/neo/)

[Pulumi Neo](https://www.pulumi.com/product/neo/)

Pulumi Neo is an AI agent that manages cloud infrastructure with Pulumi. It runs in Pulumi Cloud, the CLI, GitHub, and Slack, and works within your organization's policies and approvals.

[Setup instructions](https://www.pulumi.com/docs/ai/skills/)
...
[Setup instructions](https://geminicli.com/docs/cli/skills/)
...
[Setup instructions](https://spring.io/blog/2026/01/13/spring-ai-generic-agent-skills/)
 [Source code](https://github.com/spring-projects/spring-ai)
...
[Setup instructions](https://code.visualstudio.com/docs/copilot/customization/agent-skills)
...
[![ZeroClaw](https://agentskills.io/images/logos/zeroclaw/zeroclaw-logo-light.png)![ZeroClaw](https://agentskills.io/images/logos/zeroclaw/zeroclaw-logo-dark.png)](https://www.zeroclawlabs.ai/)

[ZeroClaw](https://www.zeroclawlabs.ai/)

ZeroClaw is an open-source, Rust-first AI agent runtime for local, provider-agnostic personal agents with Agent Skills support.

[Setup instructions](https://docs.zeroclawlabs.ai/master/en/tools/skills.html)
 [Source code](https://github.com/zeroclaw-labs/zeroclaw)
...
[Setup instructions](https://nanobot.wiki/docs/0.1.5/use-nanobot/skills)
 [Source code](https://github.com/HKUDS/nanobot)

[![Deep Code](https://agentskills.io/images/logos/deepcode/deepcode-logo-light.svg)![Deep Code](https://agentskills.io/images/logos/deepcode/deepcode-logo-dark.svg)](https://deepcode.vegamo.cn/en)

[Deep Code](https://deepcode.vegamo.cn/en)

Deep Code is an open-source terminal AI coding assistant for the DeepSeek model, supporting deep thinking, reasoning effort control, and extending its capabilities with Skills and MCP.

[Setup instructions](https://deepcode.vegamo.cn/en/docs/configuration/agent-skills)
 [Source code](https://github.com/lessweb/deepcode-cli)
...
[Setup instructions](https://bub.build/docs/build/skills/)
 [Source code](https://github.com/bubbuild/bub)
...
[Setup instructions](https://docs.letta.com/letta-code/skills/)
 [Source code](https://github.com/letta-ai/letta)

[![OpenClaw](https://agentskills.io/images/logos/openclaw/light.svg)![OpenClaw](https://agentskills.io/images/logos/openclaw/dark.svg)](https://openclaw.ai/)
...
[Setup instructions](https://docs.openclaw.ai/tools/skills)
...
[Mistral AI Vibe](https://github.com/mistralai/mistral-vibe)

Mistral Vibe is a command-line coding assistant powered by Mistral's models. It provides a conversational interface to your codebase, allowing you to use natural language to explore, modify, and interact with your projects through a powerful set of tools.

[Setup instructions](https://github.com/mistralai/mistral-vibe)
...
[Setup instructions](https://docs.emdash.sh/skills)
 [Source code](https://github.com/generalaction/emdash)

[![Hermes Agent](https://agentskills.io/images/logos/hermes-agent/hermes-agent-logo-light.svg)![Hermes Agent](https://agentskills.io/images/logos/hermes-agent/hermes-agent-logo-dark.svg)](https://hermes-agent.nousresearch.com/)

[Hermes Agent](https://hermes-agent.nousresearch.com/)

Hermes Agent is a personal AI agent by Nous Research that runs across a CLI, a desktop app, and messaging platforms. It is open source and model-agnostic, learns across sessions, and drives a real terminal and browser.

[Setup instructions](https://hermes-agent.nousresearch.com/docs/user-guide/features/skills)
...
[Setup instructions](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/docs/skills.md)
...
[Setup instructions](https://fast-agent.ai/agents/skills/)
 [Source code](https://github.com/evalstate/fast-agent)
...
[![ChatGPT & Codex](https://agentskills.io/images/logos/chatgpt/light.svg)![ChatGPT & Codex](https://agentskills.io/images/logos/chatgpt/dark.svg)](https://chatgpt.com/codex/)
...
[Setup instructions](https://developers.openai.com/codex/skills/)
...
# How to add skills support to your agent - Agent Skills
...
[Skip to main content](https://agentskills.io/client-implementation/adding-skills-support#content-area)
...
The guide notes where these differences matter. You don’t need to support every scenario — follow the path that fits your agent. **Prerequisites**: Familiarity with the [Agent Skills specification](https://agentskills.io/specification)
, which defines the `SKILL.md` file format, frontmatter fields, and directory conventions.

[​](https://agentskills.io/client-implementation/adding-skills-support#the-core-principle-progressive-disclosure)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#step-1-discover-skills)
...
Some implementations also scan `.claude/skills/` (both project-level and user-level) for pragmatic compatibility, since many existing skills are installed there. Other additional locations include ancestor directories up to the git root (useful for monorepos), [XDG](https://specifications.freedesktop.org/basedir-spec/latest/)
 config directories, and user-configured paths.

### 

[​](https://agentskills.io/client-implementation/adding-skills-support#what-to-scan-for)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#handling-name-collisions)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#trust-considerations)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#cloud-hosted-and-sandboxed-agents)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#step-2-parse-skill-md-files)
...
See the [specification](https://agentskills.io/specification)
 for the full set of frontmatter fields and their constraints.

### 

[​](https://agentskills.io/client-implementation/adding-skills-support#handling-malformed-yaml)
...
The [specification](https://agentskills.io/specification)
 defines strict constraints on the `name` field (matching the parent directory, character set, max length). The lenient approach above deliberately relaxes these to improve compatibility with skills authored for other clients.

### 

[​](https://agentskills.io/client-implementation/adding-skills-support#what-to-store)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#step-3-disclose-available-skills-to-the-model)

Step 3: Disclose available skills to the model
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------

Tell the model what skills exist without loading their full content. This is [tier 1 of progressive disclosure](https://agentskills.io/client-implementation/adding-skills-support#the-core-principle-progressive-disclosure)
.
...
The `location` field serves two purposes: it enables file-read activation (see [Step 4](https://agentskills.io/client-implementation/adding-skills-support#step-4-activate-skills)
), and it gives the model a base path for resolving relative references in the skill body (like `scripts/evaluate.py`). If your dedicated activation tool provides the skill directory path in its result (see [Structured wrapping](https://agentskills.io/client-implementation/adding-skills-support#structured-wrapping)
 in Step 4), you can omit `location` from the catalog. Otherwise, include it. Each skill adds roughly 50-100 tokens to the catalog. Even with dozens of skills installed, the catalog remains compact.

### 

[​](https://agentskills.io/client-implementation/adding-skills-support#where-to-place-the-catalog)
...
). This keeps the system prompt clean and naturally couples discovery with activation. Both work. System prompt placement is simpler and more broadly compatible; tool description embedding is cleaner when you have a dedicated activation tool.
...
Include a short instruction block alongside the catalog telling the model how and when to use skills. The wording depends on which activation mechanism you support (see [Step 4](https://agentskills.io/client-implementation/adding-skills-support#step-4-activate-skills)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#when-no-skills-are-available)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#step-4-activate-skills)

Step 4: Activate skills
-------------------------------------------------------------------------------------------------------------------------

When the model or user selects a skill, deliver the full instructions into the conversation context. This is [tier 2 of progressive disclosure](https://agentskills.io/client-implementation/adding-skills-support#the-core-principle-progressive-disclosure)
.

### 

[​](https://agentskills.io/client-implementation/adding-skills-support#model-driven-activation)

Model-driven activation

Most implementations rely on the model’s own judgment as the activation mechanism, rather than implementing harness-side trigger matching or keyword detection. The model reads the catalog (from [Step 3](https://agentskills.io/client-implementation/adding-skills-support#step-3-disclose-available-skills-to-the-model)
), decides a skill is relevant to the current task, and loads it. Two implementation patterns: **File-read activation**: The model calls its standard file-read tool with the `SKILL.md` path from the catalog. No special infrastructure needed — the agent’s existing file-reading capability is sufficient. The model receives the file content as a tool result. This is the simplest approach when the model has file access. **Dedicated tool activation**: Register a tool (e.g., `activate_skill`) that takes a skill name and returns the content. This is required when the model can’t read files directly, and optional (but useful) even when it can. Advantages over raw file reads:

*   Control what content is returned — e.g., strip YAML frontmatter or preserve it (see [What the model receives](https://agentskills.io/client-implementation/adding-skills-support#what-the-model-receives)
     below)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#user-explicit-activation)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#what-the-model-receives)
...
*   The harness can identify skill content during context compaction ([Step 5](https://agentskills.io/client-implementation/adding-skills-support#step-5-manage-skill-context-over-time)
    )
*   Bundled resources are surfaced to the model without being eagerly loaded

### 

[​](https://agentskills.io/client-implementation/adding-skills-support#listing-bundled-resources)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#permission-allowlisting)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#step-5-manage-skill-context-over-time)
...
*   Use the [structured tags](https://agentskills.io/client-implementation/adding-skills-support#structured-wrapping)
     from Step 4 to identify skill content and preserve it during compaction

### 

[​](https://agentskills.io/client-implementation/adding-skills-support#deduplicate-activations)
...
[​](https://agentskills.io/client-implementation/adding-skills-support#subagent-delegation-optional)
...
[Skip to main content](https://agentskills.io/skill-creation/best-practices#content-area)

[​](https://agentskills.io/skill-creation/best-practices#start-from-real-expertise)
...
[​](https://agentskills.io/skill-creation/best-practices#extract-from-a-hands-on-task)
...
[​](https://agentskills.io/skill-creation/best-practices#synthesize-from-existing-project-artifacts)
...
[​](https://agentskills.io/skill-creation/best-practices#refine-with-real-execution)
...
[​](https://agentskills.io/skill-creation/best-practices#spending-context-wisely)
...
[​](https://agentskills.io/skill-creation/best-practices#add-what-the-agent-lacks-omit-what-it-knows)
...
Ask yourself about each piece of content: “Would the agent get this wrong without this instruction?” If the answer is no, cut it. If you’re unsure, test it. And if the agent already handles the entire task well without the skill, the skill may not be adding value. See [Evaluating skill output quality](https://agentskills.io/skill-creation/evaluating-skills)
 for how to test this systematically.

### 

[​](https://agentskills.io/skill-creation/best-practices#design-coherent-units)
...
[​](https://agentskills.io/skill-creation/best-practices#aim-for-moderate-detail)
...
[​](https://agentskills.io/skill-creation/best-practices#match-specificity-to-fragility)
...
[​](https://agentskills.io/skill-creation/best-practices#provide-defaults-not-menus)
...
[​](https://agentskills.io/skill-creation/best-practices#favor-procedures-over-declarations)
...
This doesn’t mean skills can’t include specific details — output format templates (see [Templates for output format](https://agentskills.io/skill-creation/best-practices#templates-for-output-format)
), constraints like “never output PII,” and tool-specific instructions are all valuable. The point is that the _approach_ should generalize even when individual details are specific.

[​](https://agentskills.io/skill-creation/best-practices#patterns-for-effective-instructions)
...
[​](https://agentskills.io/skill-creation/best-practices#gotchas-sections)
...
When an agent makes a mistake you have to correct, add the correction to the gotchas section. This is one of the most direct ways to improve a skill iteratively (see [Refine with real execution](https://agentskills.io/skill-creation/best-practices#refine-with-real-execution)
).

### 

[​](https://agentskills.io/skill-creation/best-practices#templates-for-output-format)
...
[​](https://agentskills.io/skill-creation/best-practices#checklists-for-multi-step-workflows)
...
[​](https://agentskills.io/skill-creation/best-practices#plan-validate-execute)
...
[​](https://agentskills.io/skill-creation/best-practices#bundling-reusable-scripts)

Bundling reusable scripts

When [iterating on a skill](https://agentskills.io/skill-creation/evaluating-skills)
, compare the agent’s execution traces across test cases. If you notice the agent independently reinventing the same logic each run — building charts, parsing a specific format, validating output — that’s a signal to write a tested script once and bundle it in `scripts/`. For more on designing and bundling scripts, see [Using scripts in skills](https://agentskills.io/skill-creation/using-scripts)
.

[​](https://agentskills.io/skill-creation/best-practices#next-steps)
...
*   **[Evaluating skill output quality](https://agentskills.io/skill-creation/evaluating-skills)
    ** — Set up test cases, grade results, and iterate systematically.
*   **[Optimizing skill descriptions](https://agentskills.io/skill-creation/optimizing-descriptions)
    ** — Test and improve your skill’s `description` field so it triggers on the right prompts.
...
[Skip to main content](https://agentskills.io/skill-creation/optimizing-descriptions#content-area)
...
*   **Keep it concise.** A few sentences to a short paragraph is usually right — long enough to cover the skill’s scope, short enough that it doesn’t bloat the agent’s context across many skills. The [specification](https://agentskills.io/specification#description-field)
     enforces a hard limit of 1024 characters.

[​](https://agentskills.io/skill-creation/optimizing-descriptions#designing-trigger-eval-queries)
...
[​](https://agentskills.io/skill-creation/optimizing-descriptions#should-trigger-queries)
...
[​](https://agentskills.io/skill-creation/optimizing-descriptions#should-not-trigger-queries)
...
[​](https://agentskills.io/skill-creation/optimizing-descriptions#tips-for-realism)
...
[​](https://agentskills.io/skill-creation/optimizing-descriptions#testing-whether-a-description-triggers)
...
[​](https://agentskills.io/skill-creation/optimizing-descriptions#running-multiple-times)
...
[​](https://agentskills.io/skill-creation/optimizing-descriptions#avoiding-overfitting-with-train/validation-splits)
...
Make sure both sets contain a proportional mix of should-trigger and should-not-trigger queries — don’t accidentally put all the positives in one set. Shuffle randomly and keep the split fixed across iterations so you’re comparing apples to apples. If you’re using a script like the one [above](https://agentskills.io/skill-creation/optimizing-descriptions#running-multiple-times)
, you can split your queries into two files — `train_queries.json` and `validation_queries.json` — and run the script against each one separately.

[​](https://agentskills.io/skill-creation/optimizing-descriptions#the-optimization-loop)
...
The [`skill-creator`](https://github.com/anthropics/skills/tree/main/skills/skill-creator)
 Skill automates this loop end-to-end: it splits the eval set, evaluates trigger rates in parallel, proposes description improvements using Claude, and generates a live HTML report you can watch as it runs.

[​](https://agentskills.io/skill-creation/optimizing-descriptions#applying-the-result)
...
[​](https://agentskills.io/skill-creation/optimizing-descriptions#next-steps)

Next steps
-------------------------------------------------------------------------------------------

Once your skill triggers reliably, you’ll want to evaluate whether it produces good outputs. See [Evaluating skill output quality](https://agentskills.io/skill-creation/evaluating-skills)
 for how to set up test cases, grade results, and iterate.
...
[Skip to main content](https://agentskills.io/skill-creation/evaluating-skills#content-area)
...
[​](https://agentskills.io/skill-creation/evaluating-skills#designing-test-cases)
...
[​](https://agentskills.io/skill-creation/evaluating-skills#running-evals)
...
[​](https://agentskills.io/skill-creation/evaluating-skills#workspace-structure)
...
[​](https://agentskills.io/skill-creation/evaluating-skills#spawning-runs)
...
[​](https://agentskills.io/skill-creation/evaluating-skills#capturing-timing-data)
...
In Claude Code, when a subagent task finishes, the [task completion notification](https://platform.claude.com/docs/en/agent-sdk/typescript#sdk-task-notification-message)
 includes `total_tokens` and `duration_ms`. Save these values immediately — they aren’t persisted anywhere else.

[​](https://agentskills.io/skill-creation/evaluating-skills#writing-assertions)
...
Not everything needs an assertion. Some qualities — writing style, visual design, whether the output “feels right” — are hard to decompose into pass/fail checks. These are better caught during [human review](https://agentskills.io/skill-creation/evaluating-skills#reviewing-results-with-a-human)
. Reserve assertions for things that can be checked objectively. Add assertions to each test case in `evals/evals.json`:
...
[​](https://agentskills.io/skill-creation/evaluating-skills#grading-outputs)
...
[​](https://agentskills.io/skill-creation/evaluating-skills#grading-principles)
...
[​](https://agentskills.io/skill-creation/evaluating-skills#aggregating-results)
...
[​](https://agentskills.io/skill-creation/evaluating-skills#analyzing-patterns)
...
[​](https://agentskills.io/skill-creation/evaluating-skills#reviewing-results-with-a-human)
...
“The chart is missing axis labels” is actionable; “looks bad” is not. Empty feedback means the output looked fine — that test case passed your review. During the [iteration step](https://agentskills.io/skill-creation/evaluating-skills#iterating-on-the-skill)
, focus your improvements on the test cases where you had specific complaints.

[​](https://agentskills.io/skill-creation/evaluating-skills#iterating-on-the-skill)
...
*   **Bundle repeated work.** If every test run independently wrote a similar helper script (a chart builder, a data parser), that’s a signal to bundle the script into the skill’s `scripts/` directory. See [Using scripts](https://agentskills.io/skill-creation/using-scripts)
     for how to do this.

### 

[​](https://agentskills.io/skill-creation/evaluating-skills#the-loop)
...
The [`skill-creator`](https://github.com/anthropics/skills/tree/main/skills/skill-creator)
 Skill automates much of this workflow — running evals, grading assertions, aggregating benchmarks, and presenting results for human review.
...
[Skip to main content](https://agentskills.io/skill-creation/quickstart#content-area)

In this tutorial, you’ll create a skill that gives an agent the capability to roll dice using a random number generator.

[​](https://agentskills.io/skill-creation/quickstart#prerequisites)
...
[​](https://agentskills.io/skill-creation/quickstart#try-it-out)
...
[​](https://agentskills.io/skill-creation/quickstart#how-it-works)
...
[​](https://agentskills.io/skill-creation/quickstart#next-steps)
...
*   **[Best practices](https://agentskills.io/skill-creation/best-practices)
    ** — How to write skills that are well-scoped and effective.
*   **[Optimizing skill descriptions](https://agentskills.io/skill-creation/optimizing-descriptions)
    ** — Test and improve your skill’s description so it activates on the right prompts.
*   **[Specification](https://agentskills.io/specification)
    ** — The complete format reference for `SKILL.md` files.
*   **[Example skills](https://github.com/anthropics/skills)
    ** — Browse real-world skills on GitHub.
...
[Skip to main content](https://agentskills.io/skill-creation/using-scripts#content-area)
...
[​](https://agentskills.io/skill-creation/using-scripts#one-off-commands)
...
[uvx](https://docs.astral.sh/uv/guides/tools/)
 runs Python packages in isolated environments with aggressive caching. It ships with [uv](https://docs.astral.sh/uv/)
.
...
[pipx](https://pipx.pypa.io/)
 runs Python packages in isolated environments. Available via OS package managers (`apt install pipx`, `brew install pipx`).
...
[npx](https://docs.npmjs.com/cli/commands/npx)
 runs npm packages, downloading them on demand. It ships with npm (which ships with Node.js).
...
[bunx](https://bun.sh/docs/cli/bunx)
 is Bun’s equivalent of `npx`. It ships with [Bun](https://bun.sh/)
.
...
[deno run](https://docs.deno.com/runtime/reference/cli/run/)
 runs scripts directly from URLs or specifiers. It ships with [Deno](https://deno.com/)
.
...
[go run](https://pkg.go.dev/cmd/go#hdr-Compile_and_run_Go_program)
 compiles and runs Go packages directly. It is built into the `go` command.
...
[PEP 723](https://peps.python.org/pep-0723/)
 defines a standard format for inline script metadata. Declare dependencies in a TOML block inside `# ///` markers:
...
`uv run` creates an isolated environment, installs the declared dependencies, and runs the script. [pipx](https://pipx.pypa.io/)
 (`pipx run scripts/extract.py`) also supports PEP 723.

*   Pin versions with [PEP 508](https://peps.python.org/pep-0508/)
     specifiers: `"beautifulsoup4>=4.12,<5"`.
...
[​](https://agentskills.io/skill-creation/using-scripts#avoid-interactive-prompts)
...
[​](https://agentskills.io/skill-creation/using-scripts#document-usage-with-help)
...
[​](https://agentskills.io/skill-creation/using-scripts#write-helpful-error-messages)
...
[​](https://agentskills.io/skill-creation/using-scripts#use-structured-output)
