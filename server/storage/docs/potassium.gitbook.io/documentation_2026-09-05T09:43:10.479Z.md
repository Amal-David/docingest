...
object) \`\`\` Freezes \`object\` , where table.freeze would normally check for \\\_\\\_metatable. \*\*\*
...
| Method | Description |
| --- | --- |
| Send(<string> message) | Sends a message over the WebSocket connection |
...
| Event | Description |
| --- | --- |
| OnMessage(<string> message) | Fired when a message is received over the WebSocket connection |
